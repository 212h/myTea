...
// // 查找触发事件的元素
    ...
    txtUname.onfocus = txtUpwd.onfocus = txtCpwd.onfocus = txtEmail.onfocus = txtPhone.onfocus = function(){
        //查找要修改的元素
        var txt = this;
        var span = txt.parentNode.nextElementSibling.children[0];
    ...
    function cpwd(){
        var reg = /^[0-9]{6,12}$/;
        //查找要修改的元素
        var span = txtCpwd.parentNode.nextElementSibling.children[0];
        txtCpwd.className = "";
